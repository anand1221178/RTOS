...
//3. Define base address for AHB1 peripherals
...
//15. Bit mask for enabling GPIOA pin 5
#define PIN6 (1U<<6)
...
int main(void){
	...
	GPIOA_MODE_R |= (1U<<12); // 19: Set bit 13 to 0
	GPIOA_MODE_R &= ~(1U<<13); // 20: Set bit 12 to 1
